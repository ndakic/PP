...
#line 94 "hipsim.tab.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 47 "hipsim.y" /* yacc.c:355  */

    int i;
    char* s;

#line 170 "hipsim.tab.c" /* yacc.c:355  */
};
...
#line 187 "hipsim.tab.c" /* yacc.c:358  */
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 93 "hipsim.y" /* yacc.c:1646  */
    {
            add_entry_code(mainarg);
        }
#line 1321 "hipsim.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 105 "hipsim.y" /* yacc.c:1646  */
    { (yyval.i) = yylineno; }
#line 1327 "hipsim.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 107 "hipsim.y" /* yacc.c:1646  */
    {
            uchar data[256];
            int i,len = (yyvsp[0].i)*4;
            for (i=0; i<len; i++) data[i] = 0;
            insert_source("%s:\t\t\tWORD %d",(yyvsp[-3].s),(yyvsp[0].i));
...
#line 1349 "hipsim.tab.c" /* yacc.c:1646  */
  ...
  case 15:
#line 140 "hipsim.y" /* yacc.c:1646  */
    {
            insert_source("\t\t\tHALT");
            insert_code(INS_HALT, NO_TYPE, yylineno);
        }
#line 1358 "hipsim.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 148 "hipsim.y" /* yacc.c:1646  */
    {
...
#line 1491 "hipsim.tab.c" /* yacc.c:1646  */
  ...
  case 30:
#line 231 "hipsim.y" /* yacc.c:1646  */
    {
            insert_source("\t\t\tPOP %s", (yyvsp[0].s));
            insert_code(INS_POP, NO_TYPE, yylineno);
            free((yyvsp[0].s));
        }
#line 1501 "hipsim.tab.c" /* yacc.c:1646  */
    break;

  case 31:
#line 237 "hipsim.y" /* yacc.c:1646  */
    {
            insert_source("\t\t\tCALL %s", (yyvsp[0].s));
            insert_code(INS_CALL, NO_TYPE, yylineno);
        }
#line 1510 "hipsim.tab.c" /* yacc.c:1646  */
    break;

  case 32:
#line 242 "hipsim.y" /* yacc.c:1646  */
    {
            insert_source("\t\t\tRET");
            insert_code(INS_RET, NO_TYPE, yylineno);
        }
#line 1519 "hipsim.tab.c" /* yacc.c:1646  */
    break;

  case 33:
#line 250 "hipsim.y" /* yacc.c:1646  */
    {
            int l;
...
#line 1530 "hipsim.tab.c" /* yacc.c:1646  */
    break;

  case 34:
#line 260 "hipsim.y" /* yacc.c:1646  */
    {
            add_operand(OP_REGISTER,(yyvsp[0].i),0);
            (yyval.s) = make_opstr("%%%d",(yyvsp[0].i));
        }
#line 1539 "hipsim.tab.c" /* yacc.c:1646  */
    break;

  case 35:
#line 265 "hipsim.y" /* yacc.c:1646  */
    {
            add_operand(OP_INDEX,(yyvsp[-1].i),(yyvsp[-3].i));
            (yyval.s) = make_opstr("%d(%%%d)",(yyvsp[-3].i),(yyvsp[-1].i));
        }
#line 1548 "hipsim.tab.c" /* yacc.c:1646  */
    break;

  case 36:
#line 270 "hipsim.y" /* yacc.c:1646  */
    {
            add_operand(OP_INDIRECT,(yyvsp[-1].i),0);
            (yyval.s) = make_opstr("(%%%d)",(yyvsp[-1].i));
        }
#line 1557 "hipsim.tab.c" /* yacc.c:1646  */
    break;

  case 38:
#line 279 "hipsim.y" /* yacc.c:1646  */
    {
            add_operand(OP_CONSTANT,0,(yyvsp[0].i));
            (yyval.s) = make_opstr("$%d",(yyvsp[0].i));
        }
#line 1566 "hipsim.tab.c" /* yacc.c:1646  */
    break;

  case 39:
#line 284 "hipsim.y" /* yacc.c:1646  */
    {
            int l;
            (yyval.s) = make_opstr("$%s",(yyvsp[0].s));
            l = use_label((yyvsp[0].s), yylineno);
            if (symtab[l].usage == LAB_UNDEFINED)
                parsererror("Undeclared global variable %s",(yyvsp[0].s));
            add_operand(OP_CONSTANT,0,symtab[l].address);
        }
#line 1579 "hipsim.tab.c" /* yacc.c:1646  */
    break;


#line 1583 "hipsim.tab.c" /* yacc.c:1646  */
      default: break;
    }
