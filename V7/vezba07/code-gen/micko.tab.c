...
#line 169 "micko.tab.c" /* yacc.c:358  */
...
{
       0,    55,    55,    67,    68,    73,    72,    97,   103,   105,
     115,   114,   123,   125,   129,   138,   140,   144,   156,   158,
     162,   163,   164,   165,   169,   173,   187,   189,   210,   212,
     219,   225,   230,   233,   239,   238,   258,   260,   272,   275,
     281,   286,   280,   300,   310
};
#endif
...
static const char *const yytname[] =
{
  ...
  "$accept", "program", "function_list", "function", "$@1", "type",
  "parameter", "body", "$@2", "variable_list", "variable", "global_list",
  "glob_var", "statement_list", "statement", "compound_statement",
...
{
     -51,    20,    14,   -51,   -51,    14,   -51,    21,   -51,   -51,
      33,     9,   -51,   -51,    31,    14,    35,    32,   -51,    34,
     -51,   -51,    14,    37,   -51,   -51,    30,     3,   -51,    38,
      29,    36,   -51,   -51,   -51,   -51,   -51,   -51,    42,   -51,
     -51,    39,   -51,   -51,    29,   -12,   -51,   -51,   -51,    29,
      19,    23,    29,    41,    -5,   -51,    29,    -2,   -51,   -51,
      17,   -51,    29,   -51,   -51,   -51,    29,    43,    40,    44,
      40,    23,   -51,   -51
};
...
{
      15,     0,     0,     1,     7,     2,     3,     0,    16,     4,
       0,     5,     5,    17,     0,     8,     0,     0,     9,     0,
      12,     6,    10,     0,    18,    13,     0,     0,    14,     0,
       0,     0,    18,    11,    19,    20,    21,    22,    38,    23,
      40,    29,    32,    33,     0,     0,    26,    28,    30,     0,
       0,     0,     0,     0,     0,    44,     0,     0,    24,    39,
       0,    41,    36,    31,    27,    25,     0,     0,    37,     0,
      43,     0,    35,    42
};
...
{
     -51,   -51,   -51,    47,   -51,    -3,   -51,   -51,   -51,   -51,
     -51,   -51,   -51,    25,   -50,   -51,   -51,   -44,     2,   -51,
...
{
      -1,     1,     5,     6,    14,     7,    17,    21,    24,    22,
      25,     2,     8,    27,    34,    35,    36,    45,    46,    47,
      48,    53,    69,    37,    38,    52,    67,    61,    39
};
...
{
      54,    59,    10,    55,    56,    57,    63,    29,    60,    30,
      31,    56,    16,    65,    56,    32,    33,     4,    68,    23,
       3,    73,    70,    29,    13,    30,    31,    29,    11,    30,
      31,    32,    58,    56,    66,    32,    41,    42,    43,    44,
      12,    15,    18,    19,    26,    28,    20,    51,    40,   -34,
      49,    62,     9,     0,    71,    72,    56,    50,    64
};

static const yytype_int8 yycheck[] =
{
      44,    51,     5,    15,    16,    49,    11,     4,    52,     6,
       7,    16,    15,    15,    16,    12,    13,     3,    62,    22,
       0,    71,    66,     4,    15,     6,     7,     4,     7,     6,
       7,    12,    13,    16,    17,    12,     7,     8,     9,    10,
       7,    10,     7,    11,     7,    15,    12,     5,    10,    10,
      14,    10,     5,    -1,    11,    11,    16,    32,    56
};
...
{
       0,    20,    30,     0,     3,    21,    22,    24,    31,    22,
      24,     7,     7,    15,    23,    10,    24,    25,     7,    11,
      12,    26,    28,    24,    27,    29,     7,    32,    15,     4,
       6,     7,    12,    13,    33,    34,    35,    42,    43,    47,
      10,     7,     8,     9,    10,    36,    37,    38,    39,    14,
      32,     5,    44,    40,    36,    15,    16,    36,    13,    33,
      36,    46,    10,    11,    37,    15,    17,    45,    36,    41,
      36,    11,    11,    33
};
...
{
       0,    19,    20,    21,    21,    23,    22,    24,    25,    25,
      27,    26,    28,    28,    29,    30,    30,    31,    32,    32,
...
#line 1298 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 1314 "micko.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 85 "micko.y" /* yacc.c:1646  */
    {
...
#line 1328 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 1371 "micko.tab.c" /* yacc.c:1646  */
  ...
  case 17:
#line 145 "micko.y" /* yacc.c:1646  */
    {
        if(lookup_symbol((yyvsp[-1].s), GLB) == -1)
           insert_symbol((yyvsp[-1].s), GLB, (yyvsp[-2].i), NO_ATR, NO_ATR);
        else 
           err("redefinition of '%s'", (yyvsp[-1].s));
...
#line 174 "micko.y" /* yacc.c:1646  */
    {
        int idx = lookup_symbol((yyvsp[-3].s), (VAR|PAR|GLB));
        if(idx == -1)
...
#line 1483 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 1508 "micko.tab.c" /* yacc.c:1646  */
    break;
