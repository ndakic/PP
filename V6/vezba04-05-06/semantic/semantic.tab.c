...
#line 172 "semantic.tab.c" /* yacc.c:355  */
};
...
#line 187 "semantic.tab.c" /* yacc.c:358  */
...
{
       0,    78,    78,    90,    91,    96,    95,   123,   129,   131,
     143,   146,   148,   152,   156,   156,   168,   182,   195,   204,
     204,   224,   226,   229,   231,   235,   236,   240,   240,   267,
     268,   273,   272,   287,   289,   293,   294,   295,   296,   297,
     298,   299,   300,   304,   304,   308,   320,   321,   329,   330,
     336,   337,   342,   345,   351,   350,   368,   370,   380,   381,
     385,   389,   397,   409
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_INC", "_DO", "_WHILE", "_FOR", "_SWITCH", "_CASE", "_DEFAULT",
  "_COLON", "_BREAK", "ONLY_IF", "$accept", "program", "function_list",
  "function", "$@1", "type", "parameter", "body", "variable_list",
  "variable", "vars", "$@2", "do_statement", "inc_statement",
  "for_statement", "$@3", "default_statement", "break_statement",
  "case_list", "case_", "$@4", "case_body", "switch_statement", "$@5",
  "statement_list", "statement", "compound_statement", "$@6",
  "assignment_statement", "num_exp", "exp", "literal", "function_call",
  "$@7", "argument", "if_statement", "if_part", "rel_exp",
...
{
      10,  -106,    29,    10,  -106,    16,  -106,  -106,  -106,    26,
      10,    31,    47,  -106,    30,  -106,  -106,    10,  -106,  -106,
      44,    -2,    57,  -106,    70,    41,     7,    -7,  -106,  -106,
      33,    68,    69,  -106,  -106,  -106,  -106,  -106,  -106,  -106,
    -106,    75,  -106,  -106,  -106,    40,    71,  -106,  -106,    40,
    -106,    52,  -106,  -106,  -106,    40,    67,  -106,    62,    81,
      78,    33,    53,    76,    79,     8,  -106,    40,    56,  -106,
      10,    80,    84,  -106,  -106,    40,    33,    40,  -106,  -106,
    -106,    21,    85,    72,    77,    82,  -106,    82,    86,  -106,
      83,    65,    87,  -106,    65,    88,    89,    90,  -106,    65,
      51,  -106,    91,    40,  -106,    92,    94,  -106,  -106,    93,
      95,    23,  -106,    97,    23,    96,  -106,  -106,  -106,    74,
      98,   100,    99,  -106,    33,  -106,  -106
};
...
{
       0,     7,     0,     2,     3,     0,     1,     4,     5,     0,
       8,     0,     0,     9,     0,    11,     6,    33,    14,    12,
       0,     0,     0,    13,     0,     0,     0,     0,    43,    10,
       0,     0,     0,    40,    39,    41,    42,    34,    35,    36,
      37,    58,    38,    15,    16,     0,    49,    52,    53,     0,
      63,     0,    46,    48,    50,     0,     0,    11,     0,     0,
       0,     0,     0,     0,     0,     0,    62,     0,     0,    18,
      33,     0,     0,    31,    59,     0,     0,    56,    51,    47,
      45,     0,     0,     0,     0,    61,    60,    57,     0,    44,
       0,     0,     0,    55,     0,     0,     0,     0,    19,     0,
      21,    25,     0,     0,    27,     0,     0,    26,    17,     0,
       0,     0,    32,     0,     0,     0,    22,    29,    30,     0,
      23,     0,     0,    28,     0,    24,    20
};
...
{
    -106,  -106,  -106,   102,  -106,    -9,  -106,  -106,    38,  -106,
    -106,  -106,  -106,  -106,  -106,  -106,  -106,  -106,  -106,    -4,
    -106,   -12,  -106,  -106,    39,   -30,  -105,  -106,   -48,   -23,
      45,   -34,  -106,  -106,  -106,  -106,  -106,    12,  -106
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,     4,     9,     5,    12,    16,    17,    19,
      20,    22,    33,    34,    35,   103,   106,   123,   100,   101,
     110,   116,    36,    84,    21,    37,    38,    57,    39,    62,
      52,    53,    54,    64,    88,    40,    41,    63,    42
};
...
{
      58,    11,    25,    51,    26,    27,   117,    55,    18,   117,
      28,    29,    56,     1,    46,    47,    48,    49,    30,    78,
      31,    32,    50,     8,    67,    25,    65,    26,    27,     6,
     115,    74,    68,    28,    89,    28,    10,    25,    13,    26,
      27,    30,    15,    31,    32,    28,    86,    46,    47,    48,
      49,    45,    85,    30,    87,    31,    32,    95,    14,    23,
      97,    18,    24,   118,    43,   104,   118,    66,    67,    67,
      75,    80,    67,    47,    48,    99,   105,    44,    59,    60,
      61,   -54,    69,    71,    72,    73,    91,    76,    92,    77,
      82,    83,    90,   121,   126,    70,   107,    93,    67,    96,
      94,   102,   120,    98,   119,     7,   108,   112,   113,    81,
      55,   124,    79,    99,   125,   109,     0,     0,   111,     0,
       0,   114,     0,     0,     0,   122
};

static const yytype_int8 yycheck[] =
{
      30,    10,     4,    26,     6,     7,   111,    14,    17,   114,
      12,    13,    19,     3,     7,     8,     9,    10,    20,    11,
      22,    23,    15,     7,    16,     4,    49,     6,     7,     0,
       7,    61,    55,    12,    13,    12,    10,     4,     7,     6,
       7,    20,    12,    22,    23,    12,    76,     7,     8,     9,
      10,    10,    75,    20,    77,    22,    23,    91,    11,    15,
      94,    70,    18,   111,     7,    99,   114,    15,    16,    16,
      17,    15,    16,     8,     9,    24,    25,     7,    10,    10,
       5,    10,    15,    21,     3,     7,    14,    11,    11,    10,
      10,     7,     7,    19,   124,    57,   100,    11,    16,    12,
      17,    11,   114,    15,     7,     3,    15,    13,    15,    70,
      14,    11,    67,    24,    15,   103,    -1,    -1,    26,    -1,
      -1,    26,    -1,    -1,    -1,    27
};
...
{
       0,     3,    30,    31,    32,    34,     0,    32,     7,    33,
      10,    34,    35,     7,    11,    12,    36,    37,    34,    38,
      39,    53,    40,    15,    18,     4,     6,     7,    12,    13,
      20,    22,    23,    41,    42,    43,    51,    54,    55,    57,
      64,    65,    67,     7,     7,    10,     7,     8,     9,    10,
      15,    58,    59,    60,    61,    14,    19,    56,    54,    10,
      10,     5,    58,    66,    62,    58,    15,    16,    58,    15,
      37,    21,     3,     7,    54,    17,    11,    10,    11,    59,
      15,    53,    10,     7,    52,    58,    54,    58,    63,    13,
       7,    14,    11,    11,    17,    60,    12,    60,    15,    24,
      47,    48,    11,    44,    60,    25,    45,    48,    15,    66,
      49,    26,    13,    15,    26,     7,    50,    55,    57,     7,
      50,    19,    27,    46,    11,    15,    54
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      36,    37,    37,    38,    40,    39,    39,    41,    42,    44,
      43,    45,    45,    46,    46,    47,    47,    49,    48,    50,
...
#line 157 "semantic.y" /* yacc.c:1646  */
    {
        ...
        int postoji = lookup_symbol((yyvsp[0].s), VAR|PAR);
    
        if((postoji != -1) && (get_atr2(postoji) == block))
           err("redefinition1 of '%s'", (yyvsp[0].s));
        else 
          insert_symbol((yyvsp[0].s), VAR, t, ++var_num, block);
      }
...
#line 183 "semantic.y" /* yacc.c:1646  */
    {  
        int index = -1;
        if((index = lookup_symbol((yyvsp[-4].s), (VAR|PAR))) == -1)
           err("Greska, promenjiva nije definisana!'%s'", (yyvsp[-4].s));   

        if(get_type(index) != get_type((yyvsp[-2].i)))
           err("Greska, tipovi nisu isti!'%s'", (yyvsp[-4].s));  
      }
...
#line 204 "semantic.y" /* yacc.c:1646  */
    { insert_symbol((yyvsp[-3].s), VAR, (yyvsp[-4].i), ++var_num, ++block); poslednji_for = get_last_element(); }
...
#line 205 "semantic.y" /* yacc.c:1646  */
    {
      ...
      int index1 = lookup_symbol((yyvsp[-10].s), VAR);

      if(get_type(index1) != get_type((yyvsp[-8].i)))
        err("Moraju biti istog tipa!");

      int index2 = lookup_symbol((yyvsp[-3].s), VAR);
...
#line 240 "semantic.y" /* yacc.c:1646  */
    {
      ...
      while(i < nizCount){
        ...
        if(nizKonstanti[i] == (yyvsp[0].i))
          err("Case vec postoji!");

        i++;
      }

      nizKonstanti[nizCount] = (yyvsp[0].i);
      nizCount++;

      if(get_type(prom) != get_type((yyvsp[0].i)))
        err("Nisu istog tipa!");
...
#line 273 "semantic.y" /* yacc.c:1646  */
    { 
      ...
      prom = lookup_symbol((yyvsp[0].s), VAR);
      if(prom == -1)
...
#line 304 "semantic.y" /* yacc.c:1646  */
    {block++; poslednji = get_last_element(); }
#line 1546 "semantic.tab.c" /* yacc.c:1646  */
    break;

  case 44:
#line 304 "semantic.y" /* yacc.c:1646  */
    { block--; clear_symbols(poslednji + 1);}
...
#line 418 "semantic.y" /* yacc.c:1906  */
